...
# and create groups for online course students.

class OnlineGroup:
	# Defining all the data structures to be used.
	# inp - team size from user, dataframe - a dictionary which holds parsed result.
	...
	def generate_cost_matrix(self):
		...
		for i in range(n):
			...
			# Condition for adding UTC weight
	...
	def generate_group(self):
		...
		if len(remaining_students) > 0:
			...
			# Assigning teams to remaining students.
